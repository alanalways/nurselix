...
6. discharge planning / continuity of care（出院計畫與連續照護）：3 題
7. restraint / safety（約束與安全）：2 題
8. pharmacology monitoring / medication safety（藥物監測與安全）：3 題
9. change in condition / escalation（病情變化與升級通報）：3 題
...
3. id 從 rn2026_moc_XXXX 連續編號（XXXX = start_index 補零至 4 位）。
